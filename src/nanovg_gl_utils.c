...
#if defined(NANOVG_GL2) + defined(NANOVG_GL3) + defined(NANOVG_GLES2) + \
        defined(NANOVG_GLES3) !=                                        \
    1
...
NVGLUframebuffer *nvgluCreateFramebufferGL2(NVGcontext *ctx, int w, int h,
                                            int imageFlags)
#elif defined NANOVG_GL3
NVGLUframebuffer *nvgluCreateFramebufferGL3(NVGcontext *ctx, int w, int h,
                                            int imageFlags)
#elif defined NANOVG_GLES2
NVGLUframebuffer *nvgluCreateFramebufferGLES2(NVGcontext *ctx, int w, int h,
                                              int imageFlags)
#elif defined NANOVG_GLES3
NVGLUframebuffer *nvgluCreateFramebufferGLES3(NVGcontext *ctx, int w, int h,
                                              int imageFlags)
#endif
{
#ifdef NANOVG_FBO_VALID
