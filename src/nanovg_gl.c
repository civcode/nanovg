...
#if defined NANOVG_GL2
int nvglCreateImageFromHandleGL2(NVGcontext *ctx, unsigned int textureId, int w,
                                 int h, int imageFlags)
#elif defined NANOVG_GL3
int nvglCreateImageFromHandleGL3(NVGcontext *ctx, unsigned int textureId, int w,
                                 int h, int imageFlags)
#elif defined NANOVG_GLES2
int nvglCreateImageFromHandleGLES2(NVGcontext *ctx, unsigned int textureId,
                                   int w, int h, int imageFlags)
#elif defined NANOVG_GLES3
int nvglCreateImageFromHandleGLES3(NVGcontext *ctx, unsigned int textureId,
                                   int w, int h, int imageFlags)
#endif
{
